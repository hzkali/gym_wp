<?php
class gb_home_box_widget extends WP_Widget 
{
	/** constructor */
	function __construct()
	{
		$widget_options = array(
			'classname' => 'gb-home-box-widget',
    ...
    function widget($args, $instance) 
	{
		...
		$more_button_style = isset($instance['more_button_style']) ? $instance['more_button_style'] : "";

		echo $before_widget;
		?>
		<li class="home-box-container <?php echo esc_attr($color);?>"<?php echo ($custom_color!="" ? ' style="background-color: #' . esc_attr($custom_color) . '"' : ''); ?>>
			<div class="home-box">
				<?php
				if($title) 
				{
				...
				<?php endif; ?>
				<div class="news clearfix<?php echo ($title=="" && $subtitle=="" ? ' margin-top-0' : '');?>">
					<?php if($icon!=""):?>
					<div class="icon features-<?php echo esc_attr($icon);?>"<?php echo ($icon_color!="" ? " style='color: #" . esc_attr($icon_color) . ";'" : "");?>></div>
					<?php endif;
					if($content!=""): ?>
					<p class="text alternate"<?php echo ($text_color!="" ? " style='color: #" . esc_attr($text_color) . ";'" : ""); ?>>	
					<?php 
						endif;
					...
					<a class="gb-button more white<?php echo ($more_button_style!="" ? ' ' . esc_attr($more_button_style) : ''); ?>" href="<?php echo esc_attr($more_button_url); ?>" title="<?php echo esc_attr($more_button_label); ?>"><?php echo $more_button_label; ?></a>
					<?php endif; ?>
				</div>
			</div>
		</li>
    ...
    function update($new_instance, $old_instance) 
	{
		...
		$instance['more_button_style'] = isset($new_instance['more_button_style']) ? strip_tags($new_instance['more_button_style']) : '';
		return $instance;
    }
	...
	function form($instance) 
	{
		...
		$more_button_style = isset($instance['more_button_style']) ? esc_attr($instance['more_button_style']) : '';
		?>
		<p>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('text_color')); ?>"><?php _e('Content text color', 'gymbase'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('more_button_url')); ?>"><?php _e('Button url', 'gymbase'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('more_button_label')); ?>"><?php _e('Button label', 'gymbase'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('more_button_style')); ?>"><?php _e('Button style', 'gymbase'); ?></label>
			<select id="<?php echo esc_attr($this->get_field_id('more_button_style')); ?>" name="<?php echo esc_attr($this->get_field_name('more_button_style')); ?>">
				<option value=""<?php echo (empty($more_button_style) ? ' selected="selected"' : ''); ?>><?php _e('default', 'gymbase'); ?></option>
				<option <?php echo ($more_button_style=='black' ? ' selected="selected"':'');?> value='black'><?php _e("black", 'gymbase'); ?></option>
				<option <?php echo ($more_button_style=='light' ? ' selected="selected"':'');?> value='light'><?php _e("light", 'gymbase'); ?></option>
			</select>
		</p>
		<?php
	}
