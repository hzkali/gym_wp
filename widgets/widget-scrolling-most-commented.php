<?php
class gb_scrolling_most_commented_widget extends WP_Widget 
{
	/** constructor */
	function __construct()
	{
		$widget_options = array(
			'classname' => 'scrolling-most-commented-widget',
			'description' => __('Displays scrolling most commented posts list', 'gymbase')
		);
