<?php
//class
function gb_theme_single_class($atts)
{
...
//visual composer
function gb_theme_single_class_vc_init()
{
	$params = array(
		array(
			"type" => "dropdown",
	...
	vc_map( array(
		"name" => __("Single Class Template", 'gymbase'),
		"base" => "single_class",
		"class" => "",
		"controls" => "full",
...
add_action("init", "gb_theme_single_class_vc_init");
?>
