<?php
//gallery
function gb_theme_single_gymbase_gallery($atts)
{
	...
	if(get_post_type()=="gymbase_gallery")
...
//visual composer
function gb_theme_single_gymbase_gallery_vc_init()
{
	$params = array(
		array(
			"type" => "dropdown",
	...
	vc_map( array(
		"name" => __("Single Gallery Template", 'gymbase'),
		"base" => "single_gallery",
		"class" => "",
		"controls" => "full",
...
add_action("init", "gb_theme_single_gymbase_gallery_vc_init");
?>
