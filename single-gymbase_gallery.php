...
<div class="theme-page relative">
	<div class="vc_row wpb_row vc_row-fluid page-header vertical-align-table full-width">
		<div class="vc_row wpb_row vc_inner vc_row-fluid">
			...
			<?php
			/*get page with gallery template set*/
			$post_template_page_array = get_pages(array(
				'post_type' => 'page',
				'post_status' => 'publish',
				//'number' => 1,
				'meta_key' => '_wp_page_template',
				'meta_value' => 'single-gymbase_gallery.php'
			));
	...
	<div class="clearfix">
		...
		if(function_exists("vc_map"))
		{
			if(count($post_template_page_array) && isset($post_template_page))
			{
				...
				echo wpb_js_remove_wpautop(apply_filters('the_content', '[vc_row][vc_column][single_gallery][/vc_column][/vc_row]'));
		}
		else
		{
			gb_get_theme_file("/shortcodes/single-gymbase_gallery.php");
			echo do_shortcode(apply_filters('the_content', '<div class="vc_row wpb_row vc_row-fluid"><div class="vc_col-sm-12 wpb_column vc_column_container">' . gb_theme_single_gymbase_gallery(array()) . '</div></div>'));
		}
		?>
	</div>
</div>
